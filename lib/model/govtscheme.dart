class Schemes {
  ...
  Schemes(
      // ignore: non_constant_identifier_names
      {this.schemes_name, this.imageUrl, this.whocanapply,this.howtoapply, this.content,this.linkname, this.link});
}

class SchemesList {
  static List<Schemes> getSchemes() {
    return [ 
      Schemes(
          schemes_name: 'Pradhan Mantri Fasal Beema Yojana',
          imageUrl : 'https://www.royalsundaram.in/html/files/crop-insurance/Crop-Insurance-Online.jpg',
        ...
        Schemes(
          schemes_name: 'Pradhan Mantri Kisan Samman Nidhi',
          imageUrl : 'https://m.jagranjosh.com/imported/images/E/GK/PM-Kisan-Samman-Nidhi-Yojana%202020.jpg',
